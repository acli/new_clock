Notes on the citation file format
==================================================
This is a working draft for notes on the citation file format.
...
- Should there be a new field that tells the reader that this is a minimum requirement, as opposed to the software that is actually being used by the author?
